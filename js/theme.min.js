if (function (t, e) {
        ...
        function u(t, e, n, i) {
            if (oe.acceptData(t)) {
                ...
                if (c && l[c] && (i || l[c].data) || void 0 !== n || "string" != typeof e)return c || (c = a ? t[s] = Q.pop() || oe.guid++ : s), l[c] || (l[c] = a ? {} : {toJSON: oe.noop}), ("object" == typeof e || "function" == typeof e) && (i ? l[c] = oe.extend(l[c], e) : l[c].data = oe.extend(l[c].data, e)), r = l[c], i || (r.data || (r.data = {}), r = r.data), void 0 !== n && (r[oe.camelCase(e)] = n), "string" == typeof e ? (o = r[e], null == o && (o = r[oe.camelCase(e)])) : o = r, o
            }
        }
        ...
        function g(t) {
            var e = Re.split("|"), n = t.createDocumentFragment();
        ...
        function m(t, e) {
            ...
            if (!r)for (r = [], n = t.childNodes || t; null != (i = n[o]); o++)!e || oe.nodeName(i, e) ? r.push(i) : oe.merge(r, m(i, e));
        ...
        function $(t, e) {
            for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++)i = t[s], i.style && (r[s] = oe._data(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && $e(i) && (r[s] = oe._data(i, "olddisplay", N(i.nodeName)))) : (o = $e(i), (n && "none" !== n || !o) && oe._data(i, "olddisplay", o ? n : oe.css(i, "display"))));
        ...
        function R(t, e, n) {
            var i, o, r, s, a, l, c, u, d = this, p = {}, f = t.style, h = t.nodeType && $e(t), g = oe._data(t, "fxshow");
            ...
            for (i in e)if (o = e[i], mn.exec(o)) {
                ...
                p[i] = g && g[i] || oe.style(t, i)
            } else c = void 0;
            if (oe.isEmptyObject(p))"inline" === ("none" === c ? N(t.nodeName) : c) && (f.display = c); else {
                g ? "hidden"in g && (h = g.hidden) : g = oe._data(t, "fxshow", {}), r && (g.hidden = !h), h ? oe(t).show() : d.done(function () {
                    oe(t).hide()
                }), d.done(function () {
                    var e;
        ...
        function q(t, e, n) {
            var i, o, r = 0, s = bn.length, a = oe.Deferred().always(function () {
                ...
                if (o)return !1;
                for (var e = hn || O(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; l > s; s++)c.tweens[s].run(r);
            ...
            for (_(u, c.opts.specialEasing); s > r; r++)if (i = bn[r].call(c, t, u, c.opts))return i;
            return oe.map(u, H, c), oe.isFunction(c.opts.start) && c.opts.start.call(t, c), oe.fx.timer(oe.extend(l, {
                elem: t,
                anim: c,
                queue: c.opts.queue
        ...
        var Q = [], J = Q.slice, Y = Q.concat, G = Q.push, K = Q.indexOf, Z = {}, te = Z.toString, ee = Z.hasOwnProperty, ne = {}, ie = "1.11.2", oe = function (t, e) {
        ...
        oe.fn = oe.prototype = {
            ...
            }, push: G, sort: Q.sort, splice: Q.splice
        ...
        var ce = function (t) {
                ...
                if (!i && I) {
                    ...
                    if (w.qsa && (!H || !H.test(t))) {
                        if (f = d = F, h = e, g = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (c = N(t), (d = e.getAttribute("id")) ? f = d.replace(xe, "\\$&") : e.setAttribute("id", f), f = "[id='" + f + "'] ", l = c.length; l--;)c[l] = f + p(c[l]);
            ...
            function b(t, n) {
                var o = n.length > 0, r = t.length > 0, s = function (i, s, a, l, c) {
                    var u, d, p, f = 0, h = "0", g = i && [], v = [], y = $, b = i || r && T.find.TAG("*", c), x = M += null == y ? 1 : Math.random() || .1, w = b.length;
                    for (c && ($ = s !== L && s); h !== w && null != (u = b[h]); h++) {
                        if (r && u) {
            ...
            var x, w, T, C, E, N, k, S, $, D, A, j, L, O, I, H, R, _, q, F = "sizzle" + 1 * new Date, P = t.document, M = 0, B = 0, W = n(), U = n(), z = n(), X = function (t, e) {
                return t === e && (A = !0), 0
            }, V = 1 << 31, Q = {}.hasOwnProperty, J = [], Y = J.pop, G = J.push, K = J.push, Z = J.slice, te = function (t, e) {
            ...
            w = e.support = {}, E = e.isXML = function (t) {
                ...
                return i !== L && 9 === i.nodeType && i.documentElement ? (L = i, O = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), I = !E(i), w.attributes = o(function (t) {
                    ...
                    }, R = [], H = [], (w.qsa = ve.test(i.querySelectorAll)) && (o(function (t) {
                    ...
                    w.disconnectedMatch = _.call(t, "div"), _.call(t, "[s!='']:x"), R.push("!=", se)
                }), H = H.length && new RegExp(H.join("|")), R = R.length && new RegExp(R.join("|")), e = ve.test(O.compareDocumentPosition), q = e || ve.test(O.contains) ? function (t, e) {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === P && q(P, t) ? -1 : e === i || e.ownerDocument === P && q(P, e) ? 1 : D ? te(D, t) - te(D, e) : 0 : 4 & n ? -1 : 1)
                } : function (t, e) {
                    if (t === e)return A = !0, 0;
                ...
                if ((t.ownerDocument || t) !== L && j(t), n = n.replace(de, "='$1']"), !(!w.matchesSelector || !I || R && R.test(n) || H && H.test(n)))try {
                    var i = _.call(t, n);
                ...
                preFilter: {
                    ATTR: function (t) {
                        ...
                        var e, n = !t[6] && t[2];
                        return he.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && pe.test(n) && (e = N(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function (t) {
                        ...
                        return 1 === i && 0 === o ? function (t) {
                            ...
                            if (m) {
                                ...
                                if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (u = m[F] || (m[F] = {}), c = u[t] || [], f = c[0] === M && c[1], p = c[0] === M && c[2], d = f && m.childNodes[f]; d = ++f && d && d[g] || (p = f = 0) || h.pop();)if (1 === d.nodeType && ++p && d === e) {
                                        u[t] = [M, f, p];
                                        break
                                    }
                                } else if (y && (c = (e[F] || (e[F] = {}))[t]) && c[0] === M)p = c[1]; else for (; (d = ++f && d && d[g] || (p = f = 0) || h.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++p || (y && ((d[F] || (d[F] = {}))[t] = [M, p]), d !== e)););
            ...
            return d.prototype = T.filters = T.pseudos, T.setFilters = new d, N = e.tokenize = function (t, n) {
                ...
                var o, r, s, a, l, c = "function" == typeof t && t, d = !i && N(t = c.selector || t);
                if (n = n || [], 1 === d.length) {
                ...
                return (c || k(t, d))(i, e, !I, n, be.test(t) && u(e.parentNode) || e), n
        ...
        var fe, he = t.document, ge = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, me = oe.fn.init = function (t, e) {
            var n, i;
            if (!t)return this;
            if ("string" == typeof t) {
        ...
        oe.Callbacks = function (t) {
            ...
            Deferred: function (t) {
                ...
                var e, n, i, o = 0, r = J.call(arguments), s = r.length, a = 1 !== s || t && oe.isFunction(t.promise) ? s : 0, l = 1 === a ? t : oe.Deferred(), c = function (t, n, i) {
                    return function (o) {
        ...
        oe.fn.ready = function (t) {
            ...
            if (!we)if (we = oe.Deferred(), "complete" === he.readyState)setTimeout(oe.ready); else if (he.addEventListener)he.addEventListener("DOMContentLoaded", a, !1), t.addEventListener("load", a, !1); else {
        ...
        var ke = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Se = ["Top", "Right", "Bottom", "Left"], $e = function (t, e) {
        ...
        var je = /^(?:input|select|textarea)$/i, Le = /^key/, Oe = /^(?:mouse|pointer|contextmenu)|click/, Ie = /^(?:focusinfocus|focusoutblur)$/, He = /^([^.]*)(?:\.(.+)|)$/;
        oe.event = {
            global: {},
            add: function (t, e, n, i, o) {
                var r, s, a, l, c, u, d, p, f, h, g, m = oe._data(t);
                if (m) {
                    for (n.handler && (l = n, n = l.handler, o = l.selector), n.guid || (n.guid = oe.guid++), (s = m.events) || (s = m.events = {}), (u = m.handle) || (u = m.handle = function (t) {
                        return typeof oe === Ce || t && oe.event.triggered === t.type ? void 0 : oe.event.dispatch.apply(u.elem, arguments)
                    }, u.elem = t), e = (e || "").match(be) || [""], a = e.length; a--;)r = He.exec(e[a]) || [], f = g = r[1], h = (r[2] || "").split(".").sort(), f && (c = oe.event.special[f] || {}, f = (o ? c.delegateType : c.bindType) || f, c = oe.event.special[f] || {}, d = oe.extend({
                        type: f,
                        origType: g,
                        data: i,
                        handler: n,
                        ...
                        namespace: h.join(".")
                    }, l), (p = s[f]) || (p = s[f] = [], p.delegateCount = 0, c.setup && c.setup.call(t, i, h, u) !== !1 || (t.addEventListener ? t.addEventListener(f, u, !1) : t.attachEvent && t.attachEvent("on" + f, u))), c.add && (c.add.call(t, d), d.handler.guid || (d.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, d) : p.push(d), oe.event.global[f] = !0);
                    t = null
                }
            },
            remove: function (t, e, n, i, o) {
                var r, s, a, l, c, u, d, p, f, h, g, m = oe.hasData(t) && oe._data(t);
                if (m && (u = m.events)) {
                    for (e = (e || "").match(be) || [""], c = e.length; c--;)if (a = He.exec(e[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f) {
                        for (d = oe.event.special[f] || {}, f = (i ? d.delegateType : d.bindType) || f, p = u[f] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = p.length; r--;)s = p[r], !o && g !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (p.splice(r, 1), s.selector && p.delegateCount--, d.remove && d.remove.call(t, s));
                        l && !p.length && (d.teardown && d.teardown.call(t, h, m.handle) !== !1 || oe.removeEvent(t, f, m.handle), delete u[f])
                    } else for (f in u)oe.event.remove(t, f + e[c], n, i, !0);
                    oe.isEmptyObject(u) && (delete m.handle, oe._removeData(t, "events"))
                }
            },
            trigger: function (e, n, i, o) {
                var r, s, a, l, c, u, d, p = [i || he], f = ee.call(e, "type") ? e.type : e, h = ee.call(e, "namespace") ? e.namespace.split(".") : [];
                if (a = u = i = i || he, 3 !== i.nodeType && 8 !== i.nodeType && !Ie.test(f + oe.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), s = f.indexOf(":") < 0 && "on" + f, e = e[oe.expando] ? e : new oe.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : oe.makeArray(n, [e]), c = oe.event.special[f] || {}, o || !c.trigger || c.trigger.apply(i, n) !== !1)) {
                    if (!o && !c.noBubble && !oe.isWindow(i)) {
                        for (l = c.delegateType || f, Ie.test(l + f) || (a = a.parentNode); a; a = a.parentNode)p.push(a), u = a;
                        u === (i.ownerDocument || he) && p.push(u.defaultView || u.parentWindow || t)
                    }
                    for (d = 0; (a = p[d++]) && !e.isPropagationStopped();)e.type = d > 1 ? l : c.bindType || f, r = (oe._data(a, "events") || {})[e.type] && oe._data(a, "handle"), r && r.apply(a, n), r = s && a[s], r && r.apply && oe.acceptData(a) && (e.result = r.apply(a, n), e.result === !1 && e.preventDefault());
                    if (e.type = f, !o && !e.isDefaultPrevented() && (!c._default || c._default.apply(p.pop(), n) === !1) && oe.acceptData(i) && s && i[f] && !oe.isWindow(i)) {
            ...
            dispatch: function (t) {
                t = oe.event.fix(t);
                var e, n, i, o, r, s = [], a = J.call(arguments), l = (oe._data(this, "events") || {})[t.type] || [], c = oe.event.special[t.type] || {};
            ...
            fix: function (t) {
                ...
                for (s || (this.fixHooks[o] = s = Oe.test(o) ? this.mouseHooks : Le.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new oe.Event(r), e = i.length; e--;)n = i[e], t[n] = r[n];
        ...
        var Re = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", _e = / jQuery\d+="(?:null|\d+)"/g, qe = new RegExp("<(?:" + Re + ")[\\s/>]", "i"), Fe = /^\s+/, Pe = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Me = /<([\w:]+)/, Be = /<tbody/i, We = /<|&#?\w+;/, Ue = /<(?:script|style|link)/i, ze = /checked\s*(?:[^=]|=\s*.checked.)/i, Xe = /^$|\/(?:java|ecma)script/i, Ve = /^true\/(.*)/, Qe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Je = {
        ...
        }, Ye = g(he), Ge = Ye.appendChild(he.createElement("div"));
        Je.optgroup = Je.option, Je.tbody = Je.tfoot = Je.colgroup = Je.caption = Je.thead, Je.th = Je.td, oe.extend({
            clone: function (t, e, n) {
                ...
                if (ne.html5Clone || oe.isXMLDoc(t) || !qe.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (Ge.innerHTML = t.outerHTML, Ge.removeChild(r = Ge.firstChild)), !(ne.noCloneEvent && ne.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || oe.isXMLDoc(t)))for (i = m(r), a = m(t), s = 0; null != (o = a[s]); ++s)i[s] && C(o, i[s]);
                if (e)if (n)for (a = a || m(t), i = i || m(r), s = 0; null != (o = a[s]); s++)T(o, i[s]); else T(t, r);
                return i = m(r, "script"), i.length > 0 && w(i, !l && m(t, "script")), i = a = o = null, r
            }, buildFragment: function (t, e, n, i) {
                for (var o, r, s, a, l, c, u, d = t.length, p = g(e), f = [], h = 0; d > h; h++)if (r = t[h], r || 0 === r)if ("object" === oe.type(r))oe.merge(f, r.nodeType ? [r] : r); else if (We.test(r)) {
                    for (a = a || p.appendChild(e.createElement("div")), l = (Me.exec(r) || ["", ""])[1].toLowerCase(), u = Je[l] || Je._default, a.innerHTML = u[1] + r.replace(Pe, "<$1></$2>") + u[2], o = u[0]; o--;)a = a.lastChild;
                    if (!ne.leadingWhitespace && Fe.test(r) && f.push(e.createTextNode(Fe.exec(r)[0])), !ne.tbody)for (r = "table" !== l || Be.test(r) ? "<table>" !== u[1] || Be.test(r) ? 0 : a : a.firstChild, o = r && r.childNodes.length; o--;)oe.nodeName(c = r.childNodes[o], "tbody") && !c.childNodes.length && r.removeChild(c);
            ...
            text: function (t) {
                ...
                for (var n, i = t ? oe.filter(t, this) : this, o = 0; null != (n = i[o]); o++)e || 1 !== n.nodeType || oe.cleanData(m(n)), n.parentNode && (e && oe.contains(n.ownerDocument, n) && w(m(n, "script")), n.parentNode.removeChild(n));
                return this
            }, empty: function () {
                ...
                return De(this, function (t) {
                    ...
                    if (!("string" != typeof t || Ue.test(t) || !ne.htmlSerialize && qe.test(t) || !ne.leadingWhitespace && Fe.test(t) || Je[(Me.exec(t) || ["", ""])[1].toLowerCase()])) {
                        t = t.replace(Pe, "<$1></$2>");
                        try {
                ...
                t = Y.apply([], t);
                var n, i, o, r, s, a, l = 0, c = this.length, u = this, d = c - 1, p = t[0], f = oe.isFunction(p);
                if (f || c > 1 && "string" == typeof p && !ne.checkClone && ze.test(p))return this.each(function (n) {
                    var i = u.eq(n);
                ...
                if (c && (a = oe.buildFragment(t, this[0].ownerDocument, !1, this), n = a.firstChild, 1 === a.childNodes.length && (a = n), n)) {
                    for (r = oe.map(m(a, "script"), b), o = r.length; c > l; l++)i = a, l !== d && (i = oe.clone(i, !0, !0), o && oe.merge(r, m(i, "script"))), e.call(this[l], i, l);
        ...
        var sn = /alpha\([^)]*\)/i, an = /opacity\s*=\s*([^)]*)/, ln = /^(none|table(?!-c[ea]).+)/, cn = new RegExp("^(" + ke + ")(.*)$", "i"), un = new RegExp("^([+-])=(" + ke + ")", "i"), dn = {
            position: "absolute",
            visibility: "hidden",
            display: "block"
        ...
        oe.extend({
            ...
            css: function (t, e, n, i) {
                ...
                return e = oe.cssProps[a] || (oe.cssProps[a] = S(t.style, a)), s = oe.cssHooks[e] || oe.cssHooks[a], s && "get"in s && (r = s.get(t, !0, n)), void 0 === r && (r = en(t, e, i)), "normal" === r && e in pn && (r = pn[e]), "" === n || n ? (o = parseFloat(r), n === !0 || oe.isNumeric(o) ? o || 0 : r) : r
            }
            ...
            constructor: L, init: function (t, e, n, i, o, r) {
        ...
        var hn, gn, mn = /^(?:toggle|show|hide)$/, vn = new RegExp("^(?:([+-])=|)(" + ke + ")([a-z%]*)$", "i"), yn = /queueHooks$/, bn = [R], xn = {
            "*": [function (t, e) {
        ...
        var Tn, Cn, En = oe.expr.attrHandle, Nn = /^(?:checked|selected)$/i, kn = ne.getSetAttribute, Sn = ne.input;
        oe.fn.extend({
            attr: function (t, e) {
            ...
            attr: function (t, e, n) {
                ...
                if (r && 1 === t.nodeType)for (; n = r[o++];)i = oe.propFix[n] || n, oe.expr.match.bool.test(n) ? Sn && kn || !Nn.test(n) ? t[i] = !1 : t[oe.camelCase("default-" + n)] = t[i] = !1 : oe.attr(t, n, ""), t.removeAttribute(kn ? n : i)
            }, attrHooks: {
                type: {
                    set: function (t, e) {
            ...
            set: function (t, e, n) {
                return e === !1 ? oe.removeAttr(t, n) : Sn && kn || !Nn.test(n) ? t.setAttribute(!kn && oe.propFix[n] || n, n) : t[oe.camelCase("default-" + n)] = t[n] = !0, n
            }
        }, oe.each(oe.expr.match.bool.source.match(/\w+/g), function (t, e) {
            var n = En[e] || oe.find.attr;
            En[e] = Sn && kn || !Nn.test(e) ? function (t, e, i) {
                var o, r;
        ...
        var $n = /^(?:input|select|textarea|button|object)$/i, Dn = /^(?:a|area)$/i;
        oe.fn.extend({
            prop: function (t, e) {
        ...
        oe.fn.extend({
            addClass: function (t) {
                ...
                if (c)for (e = (t || "").match(be) || []; l > a; a++)if (n = this[a], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(An, " ") : " ")) {
        ...
        var In, Hn, Rn = /#.*$/, _n = /([?&])_=[^&]*/, qn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Fn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Pn = /^(?:GET|HEAD)$/, Mn = /^\/\//, Bn = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Wn = {}, Un = {}, zn = "*/".concat("*");
        try {
            Hn = location.href
        } catch (Xn) {
            Hn = he.createElement("a"), Hn.href = "", Hn = Hn.href
        }
        In = Bn.exec(Hn.toLowerCase()) || [], oe.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ajaxSettings: {
            ...
            serialize: function () {
                ...
                return this.map(function () {
                    ...
                    return null == n ? null : oe.isArray(n) ? oe.map(n, function (t) {
                        return {name: e.name, value: t.replace(Jn, "\r\n")}
        ...
        oe.ajaxSetup({
            ...
            return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = oe.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(ni, "$1" + o) : e.jsonp !== !1 && (e.url += (Ln.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
        ...
        oe.offset = {
            setOffset: function (t, e, n) {
                var i, o, r, s, a, l, c, u = oe.css(t, "position"), d = oe(t), p = {};
                "static" === u && (t.style.position = "relative"), a = d.offset(), r = oe.css(t, "top"), l = oe.css(t, "left"), c = ("absolute" === u || "fixed" === u) && oe.inArray("auto", [r, l]) > -1, c ? (i = d.position(), s = i.top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), oe.isFunction(e) && (e = e.call(t, n, a)), null != e.top && (p.top = e.top - a.top + s), null != e.left && (p.left = e.left - a.left + o), "using"in e ? e.using.call(t, p) : d.css(p)
            }
        }, oe.fn.extend({
            offset: function (t) {
                ...
                if (r)return e = r.documentElement, oe.contains(e, o) ? (typeof o.getBoundingClientRect !== Ce && (i = o.getBoundingClientRect()), n = V(r), {
...
}(jQuery), Foil = {}, function (t, e, n, i) {
    n.menuToggle = function () {
        t("#wrapper").toggleClass("toggled")
    }, n.getActiveItem = function () {
        return t("#sidebar-wrapper li ul li.active")
    }, n.setActiveItem = function () {
        n.getActiveItem().addClass("active").closest("ul").slideDown().siblings("a.section").addClass("active").children("i").removeClass("fa-caret-right").addClass("fa-caret-down")
    }, n.noActiveSections = function (e) {
        return t("#sidebar-wrapper a.section").not(e).removeClass("active").children("i").removeClass("fa-caret-down").addClass("fa-caret-right").parent().siblings("ul").slideUp(), e
    }, n.setActiveSection = function (t) {
        n.noActiveSections(t).addClass("active").children("i").removeClass("fa-caret-right").addClass("fa-caret-down").parent().siblings("ul").addClass("active").slideDown()
    }, t(document).on("click", "#sidebar-wrapper a.section", function (e) {
        e.preventDefault(), $sel = t(this), $sel.hasClass("active") || n.setActiveSection($sel)
    }), t(document).on("click", "#menu-toggle", function (t) {
        t.preventDefault(), n.menuToggle()
    }), t(document).on("click", "#back-top", function (e) {
        e.preventDefault(), t("body,html").animate({scrollTop: 0}, 800)
    }), t(i).scroll(function () {
        t(this).scrollTop() > 100 ? t("#back-top").fadeIn() : t("#back-top").fadeOut()
    }), t(document).ready(function () {
        e.initHighlightingOnLoad(), t("#content h1").eq(0).wrap('<div class="page-header" />'), t("#back-top").hide(), n.setActiveItem()
    })
