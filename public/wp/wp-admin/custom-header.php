...
class Custom_Image_Header
{
    ...
    public function help()
    {
        ...
        get_current_screen()->add_help_tab(array(
            ...
            'content' => '<p>'.sprintf(__('For most themes, the header text is your Site Title and Tagline, as defined in the <a href="%1$s">General Settings</a> section.'), admin_url('options-general.php')).'<p>'.
