...
<?php
    ...
    public function column_title($post)
    {
        ...
        ?>
				...
				<span aria-hidden="true"><?php echo $title;
        ?></span>
				<span class="screen-reader-text"><?php printf(__('Edit &#8220;%s&#8221;'), $title);
        ?></span>
			<?php echo $link_end;
        ?>
		...
		<p class="filename"><span class="screen-reader-text"><?php _e('File name:');
        ?> </span><?php echo wp_basename($post->guid);
        ?></p>
		<?php
    ...
    echo $title;
            ...
            ?>
			<a class="hide-if-no-js detach-from-parent" href="<?php echo $detach_url ?>"><?php _e('Detach');
            ?></a>
			<?php endif;
        } else {
            _e('(Unattached)');
