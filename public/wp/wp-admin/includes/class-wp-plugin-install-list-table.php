...
<?php
    ...
    public function display_rows()
    {
		...
		<div class="plugin-card plugin-card-<?php echo sanitize_html_class($plugin['slug']);
            ...
            ?>" class="thickbox plugin-icon"><img src="<?php echo esc_attr($plugin_icon_url) ?>" /></a>
				<div class="name column-name">
					<h4><a href="<?php echo esc_url($details_link);
            ?>" class="thickbox"><?php echo $title;
            ?></a></h4>
				</div>
            ...
            ?></strong> <span title="<?php echo esc_attr(date_i18n($date_format, $last_updated_timestamp));
            ?>">
